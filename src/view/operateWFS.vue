<template>
  ...
  >
    ...
    <el-checkbox id="check1" v-model="checked1" :checked="checked1" label="选择要素" border size="small" @click="selectFeature"  />
    <el-checkbox id="check2" v-model="checked2" :checked="checked2" label="编辑要素" border size="small" @click="editFeature" />
